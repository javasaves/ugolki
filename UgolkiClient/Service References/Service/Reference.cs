...
namespace UgolkiClient.Service {
    ...
    public partial class Move : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private UgolkiClient.Service.Vector2[] PathField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public UgolkiClient.Service.Vector2[] Path {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://Microsoft.ServiceModel.Samples", ConfigurationName="Service.IUgolkiService", CallbackContract=typeof(UgolkiClient.Service.IUgolkiServiceCallback), SessionMode=System.ServiceModel.SessionMode.Required)]
    public interface IUgolkiService {
        ...
        System.Collections.Generic.Dictionary<UgolkiClient.Service.Move, double> GetMoves(int[][] cells, int player, int steps, UgolkiClient.Service.Vector2 playerPoint, int secondPlayer, bool first);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://Microsoft.ServiceModel.Samples/IUgolkiService/GetMoves", ReplyAction="http://Microsoft.ServiceModel.Samples/IUgolkiService/GetMovesResponse")]
        System.Threading.Tasks.Task<System.Collections.Generic.Dictionary<UgolkiClient.Service.Move, double>> GetMovesAsync(int[][] cells, int player, int steps, UgolkiClient.Service.Vector2 playerPoint, int secondPlayer, bool first);
    ...
    public interface IUgolkiServiceCallback {
        ...
        System.Collections.Generic.Dictionary<UgolkiClient.Service.Move, double> FindMoves(int[][] cells, int player, int steps, UgolkiClient.Service.Vector2 playerPoint, int secondPlayer, bool first);
        ...
        System.Collections.Generic.Dictionary<UgolkiClient.Service.Move, double> FindMovesStart(UgolkiClient.Service.Move[] startMoves, int[][] cells, int player, int steps, UgolkiClient.Service.Vector2 playerPoint, int secondPlayer, bool first);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IUgolkiServiceChannel : UgolkiClient.Service.IUgolkiService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class UgolkiServiceClient : System.ServiceModel.DuplexClientBase<UgolkiClient.Service.IUgolkiService>, UgolkiClient.Service.IUgolkiService {
        ...
        public System.Collections.Generic.Dictionary<UgolkiClient.Service.Move, double> GetMoves(int[][] cells, int player, int steps, UgolkiClient.Service.Vector2 playerPoint, int secondPlayer, bool first) {
            return base.Channel.GetMoves(cells, player, steps, playerPoint, secondPlayer, first);
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.Dictionary<UgolkiClient.Service.Move, double>> GetMovesAsync(int[][] cells, int player, int steps, UgolkiClient.Service.Vector2 playerPoint, int secondPlayer, bool first) {
